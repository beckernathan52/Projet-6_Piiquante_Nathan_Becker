...
import { createSauce, deleteSauce, getAllSauce, getOneSauce, modifySauce, likeOrDislike } from '../controllers/sauce.js'
...
routerSauces.post('/:id/like', authentication, likeOrDislike)
